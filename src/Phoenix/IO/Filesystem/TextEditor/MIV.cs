...
namespace Phoenix
{
    class MIV
    {
                    ...
                    do
                    {
                        ...
                        if (keyInfo.Key == ConsoleKey.Enter)
                        {
                            ...
                            else if (infoBar == ":w")
                            {
                                ...
                                File.WriteAllText(CurrentFile, returnString);
                                infoBar = $"Content has been saved to \"{CurrentFile}\".";
                                printMIVScreen(chars, pos, infoBar, editMode);
                            }
                            else if (infoBar == ":q")
                            {
        ...
        public static void StartMIV(string File)
        {
            try
            {
                if (File != null)
                {
                    ...
                    else
                    {
                        ...
                        System.IO.File.Create(CurrentFile);
                    }
                }
            ...
            if (File != null)
            {
                text = miv(System.IO.File.ReadAllText(CurrentFile));
            }
            else
            {
                text = miv(null);
            ...
            if (text != null)
            {
                System.IO.File.WriteAllText(CurrentFile, text);
